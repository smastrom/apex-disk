...
Prefix reference: **`reference/logging.md`**. In the log paste: `[apex:vue:…]` = intentional TS logs; `[apex:vue/…]` = uncaught web errors (stderr); `[apex:rust:…]` = Rust IPC / updater. Unprefixed lines may be Tauri/Wry.
