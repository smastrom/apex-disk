...
fn is_path_skipped_exact_match() {
    assert!(safe_folders::is_path_skipped(
        Path::new("/Users/testuser/.ssh"),
        home()
    ));
    assert!(safe_folders::is_path_skipped(
        Path::new("/Users/testuser/.gnupg"),
        home()
    ));
    assert!(safe_folders::is_path_skipped(
        Path::new("/Users/testuser/.Trash"),
        home()
    ));
    assert!(safe_folders::is_path_skipped(
        Path::new("/Users/testuser/Library/Keychains"),
        home()
    ));
}
...
fn is_path_skipped_descendant() {
    assert!(safe_folders::is_path_skipped(
        Path::new("/Users/testuser/.ssh/id_rsa"),
        home()
    ));
    assert!(safe_folders::is_path_skipped(
        Path::new("/Users/testuser/.ssh/known_hosts"),
        home()
    ));
    assert!(safe_folders::is_path_skipped(
...
fn is_path_skipped_under_home_but_not_skipped() {
    assert!(!safe_folders::is_path_skipped(
        Path::new("/Users/testuser/Documents"),
        home()
    ));
    assert!(!safe_folders::is_path_skipped(
        Path::new("/Users/testuser/MyFolder"),
        home()
    ));
}
...
fn is_path_protected_exact_match() {
    assert!(safe_folders::is_path_protected(
        Path::new("/Users/testuser/Library"),
        home()
    ));
    assert!(safe_folders::is_path_protected(
        Path::new("/Users/testuser/Documents"),
    ...
    assert!(safe_folders::is_path_protected(
        Path::new("/Users/testuser/Desktop"),
        home()
    ));
    assert!(safe_folders::is_path_protected(
...
fn is_path_protected_non_protected_sibling() {
    assert!(!safe_folders::is_path_protected(
        Path::new("/Users/testuser/MyData"),
        home()
    ));
    assert!(!safe_folders::is_path_protected(
        Path::new("/Users/testuser/Projects"),
        home()
    ));
}
