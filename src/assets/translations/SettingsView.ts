export const SettingsView = {
   en: {
      ...
      permanentlyDeleteDesc: 'By default, objects are moved to Trash.',
   ...
   it: {
      ...
      permanentlyDeleteDesc: 'Di default gli oggetti vengono spostati nel Cestino.',
   ...
   es: {
      ...
      permanentlyDeleteDesc: 'Por defecto, los objetos se mueven a la Papelera.',
   ...
   zh: {
      ...
      permanentlyDeleteDesc: '默认情况下，对象会移至废纸篓。',
   ...
   ja: {
      ...
      permanentlyDeleteDesc: 'デフォルトでは、オブジェクトはゴミ箱に移動します。',
   ...
   ar: {
      ...
      permanentlyDeleteDesc: 'افتراضيًا، يتم نقل الكائنات إلى سلة المهملات.',
   ...
   ru: {
      ...
      permanentlyDeleteDesc: 'По умолчанию объекты перемещаются в корзину.',
   ...
   fr: {
      ...
      permanentlyDeleteDesc: 'Par défaut, les éléments sont déplacés dans la corbeille.',
   ...
   pt: {
      ...
      permanentlyDelete: 'Eliminar permanentemente',
      permanentlyDeleteDesc: 'Por predefinição, os objetos são movidos para o Lixo.',
   ...
   de: {
      ...
      permanentlyDeleteDesc: 'Standardmäßig werden Objekte in den Papierkorb verschoben.',
